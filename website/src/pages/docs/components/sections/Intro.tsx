  ...
  return (
    <div className="section">
        ...
        <table>
          <tr>
            ...
            <td>
              <h5>Простота</h5>
              <p>
                Создавайте состояние без лишних усилий. Чтобы создать состояние
                необходимо просто создать класс и указать значения по умолчанию,
                после чего его уже можно использовать.
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              <p>
                Скорость работы обеспечивается меньшим количеством выполняемого
                кода в моменте работы вашего приложения. Projectx.State
                продвигает идею микро-состояний что позволяет выполнять меньшее
                количество селекторов и мемоизаций при работе с данными.
                Использование пдход с использованием вотчеров вовсе приближено к
                сложности O(1). Также данная библиотека не делает лишних
                сравнений и копий объектов, совершение мутации объекта
                гарантирует уведомления слушателей.
              </p>
            </td>
          </tr>
        </table>
      ...
      <div>
        ...
        <ul>
          <li>
            Поддержка <a href="https://reactjs.org/">React</a> 16+
          </li>
          <li>
          ...
          <li>
            Скоро! Поддержка <a href="https://ru.vuejs.org/">Vue</a>
          </li>
        </ul>
      </div>
